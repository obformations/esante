...
@RestController
@RequestMapping("/api/esante-kafka")
public class EsanteKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EsanteKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public EsanteKafkaResource(KafkaProperties kafkaProperties) {
